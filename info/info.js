export const ShipInfo = {
  ...
  Frigate: {
    ...
    gunInfo: {
      ...
      bulletInfo: {
        ...
        decay: 1 / 5000,
        damage: 5,
        fillStyle: 'rgba( 200, 255, 255, 0.7 )',
      },
      offsets: [
        { front:  0, side: -20, angle: 0 },
        { front: 10, side: -10, angle: 0 },
        { front: 10, side:  10, angle: 0 }, 
        { front:  0, side:  20, angle: 0 }, 
      ],
    },
  ...
  Destroyer: {
    ...
    gunInfo: {
      ...
      offsets: [
        { front: 10, side: -30, angle:  0.2 },
        { front: 20, side: -20, angle:  0.1 },
        { front: 30, side: -10, angle:  0.0 },
        { front: 30, side:  10, angle: -0.0 }, 
        { front: 20, side:  20, angle: -0.1 }, 
        { front: 10, side:  30, angle: -0.2 },
      ],
